...
public class CustomerInfo {
	...
	public CustomerInfo(String user) {
		...
		DefaultTableModel CI_MainTable_Model = new DefaultTableModel(d.getCustomerInfo(0, "", ""),
				CI_MainTable_Cn) {
			/**
			 * 
			 */
		...
		CI_AlterFrame_AddB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (name.length() != 0 && contact.length() != 0 && tel.length() != 0 && addr.length() != 0) {
					...
					d.alterCustomer(CI_AlterFrame, name, contact, tel, addr,
							CI_MainTable.getValueAt(row, 0).toString());
					CI_MainTable_Model.setDataVector(d.getCustomerInfo(0, "", ""), CI_MainTable_Cn);
		...
		CI_AddFrame_AddB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (name.length() != 0 && contact.length() != 0 && tel.length() != 0 && addr.length() != 0) {
					d.addCustomer(CI_AddFrame, name, contact, tel, addr, 0);
		...
		CI_MainTable_QueryB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
				CI_MainTable_Model.setDataVector(d.getCustomerInfo(0, CI_MainTable_QueryTF.getText().trim(),
						CI_MainTable_QueryTF.getText().trim()), CI_MainTable_Cn);
				TableColumn cI_MainTable_Col0 = CI_MainTable.getColumnModel().getColumn(0); // 设置列宽
				cI_MainTable_Col0.setPreferredWidth(40);
				cI_MainTable_Col0.setMinWidth(40);
				cI_MainTable_Col0.setMaxWidth(40);
