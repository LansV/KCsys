...
public class PrintWx {
							...
							job.setPrintable(new Printable() {
								public int print(Graphics graphics, PageFormat pageFormat, int pageIndex)
									...
									if (pageIndex > 0) {
										...
										g2.setFont(font);
										g2.setFont(font);
										g2.drawString("天澜清洗设备维修单", 190, 35);
										font2 = new Font("宋体", Font.PLAIN, 10);
										g2.setFont(font2);
										g2.drawString("地址:江门市蓬江区潮连坦边方岳里1号   电话:0750-3327669  Fax:0750-3226508", 100,
												50);
	...
	class Draw extends JPanel {
		...
		public void paint(Graphics g) {
			...
			g2.setFont(font);
			g2.drawString("天澜清洗设备维修单", 170, 35);
			font2 = new Font("宋体", Font.PLAIN, 10);
			g2.setFont(font2);
			...
			// System.out.println(y);
			g2.drawString("开单人:" + user + "                               经手人:                          收货人:", 20,
					y + 20);
			g2.drawString("白色:存根联         红色:记账联      蓝色:收款联         黄色:收货联", 20, y + 40);
		}
	}
